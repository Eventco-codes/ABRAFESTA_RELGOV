...
import type { PendenciaAnexo } from "@/lib/types";
import { excluirAnexoPendencia } from "./actions";
        ...
        <button
          ...
          onClick={() =>
            startTransition(async () => {
              await excluirAnexoPendencia(anexo.$id, pendenciaId);
              router.refresh();
            })
          }
